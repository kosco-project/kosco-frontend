  ...
  <>
    { D1 && (
      ...
      <div className='top-description'>
        ...
        <div className='form2'>
          CO2 installation mark; <input type='text' data-key="4" data-form="D1" value={D1[4]} onChange={onChange} />
        </div>
        <div className='form2'>
          CO2 flooding line leading to; <input type='text' data-key="5" data-form="D1" value={D1[5]} onChange={onChange} style={{ width: 30 }} /> <span>Nos.</span>
        </div>
        <div className='form1'>
