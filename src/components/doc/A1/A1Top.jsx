  ...
  <>
    { D1 && (
      ...
      <div className='top-description'>
        ...
        <div className='form2'>
          CO2 installation mark; <input type='text' data-name="4" data-form="D1" value={D1[4]} onChange={e => onChangeD1(e)} />
        </div>
        <div className='form2'>
          CO2 flooding line leading to; <input type='text' data-name="5" data-form="D1" value={D1[5]} onChange={e => onChangeD1(e)} style={{ width: 30 }} /> <span>Nos.</span>
        </div>
        <div className='form1'>
