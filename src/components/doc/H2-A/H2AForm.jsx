...
const H2AForm = ({ onChange, onRemove, onInsert, onChangeTextArea, units, showModal, showCommModal }) => {

  return (
    <form>
      <Info />
      <H2ATop onChange={onChange} onRemove={onRemove} onInsert={onInsert} units={units}/>
