        ...
        <table>
          ...
          <tbody>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[11].CarriedOut === 1} data-name="11" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[11].NotCarried === 1} data-name="11" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[11].NotApp === 1} data-name="11" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[12].CarriedOut === 1} data-name="12" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[12].NotCarried === 1} data-name="12" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[12].NotApp === 1} data-name="12" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[13].CarriedOut === 1} data-name="13" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[13].NotCarried === 1} data-name="13" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[13].NotApp === 1} data-name="13" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="13" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[14].CarriedOut === 1} data-name="14" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[14].NotCarried === 1} data-name="14" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[14].NotApp === 1} data-name="14" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="14" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[15].CarriedOut === 1} data-name="15" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[15].NotCarried === 1} data-name="15" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[15].NotApp === 1} data-name="15" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="15" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[16].CarriedOut === 1} data-name="16" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[16].NotCarried === 1} data-name="16" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[16].NotApp === 1} data-name="16" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="16" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[17].CarriedOut === 1} data-name="17" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[17].NotCarried === 1} data-name="17" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[17].NotApp === 1} data-name="17" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="17" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[18].CarriedOut === 1} data-name="18" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[18].NotCarried === 1} data-name="18" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[18].NotApp === 1} data-name="18" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="18" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[19].CarriedOut === 1} data-name="19" data-key="CarriedOut" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[19].NotCarried === 1} data-name="19" data-key="NotCarried" onChange={checkState}/>
              </td>
              <td>
                <input type='checkbox' data-form="D2" checked={state.D2[19].NotApp === 1} data-name="19" data-key="NotApp" onChange={checkState}/>
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="19" data-key="Comm" onChange={onWorkingSystem}/>
              </td>
            </tr>
          </tbody>
        </table>
