...
const A3Bottom = ({ onWorkingSystem, onWorkingSystemChecked }) => {
  return (
    <BottomBox>
          ...
          <tbody>
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="0" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="1" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="2" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="3" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="4" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="5" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="6" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="7" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="8" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="9" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="10" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="11" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="12" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <input type='checkbox' data-form="D2" data-name="13" data-key="carriedOut" onChange={onWorkingSystemChecked} />
              </td>
              <td>
              <input type='checkbox' data-form="D2" data-name="13" data-key="notCarried" onChange={onWorkingSystemChecked} />
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="13" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <input type='checkbox' data-form="D2" data-name="14" data-key="carriedOut" onChange={onWorkingSystemChecked} />
              </td>
              <td>
              <input type='checkbox' data-form="D2" data-name="14" data-key="notCarried" onChange={onWorkingSystemChecked} />
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="14" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
              <input type='checkbox' data-form="D2" data-name="15" data-key="carriedOut" onChange={onWorkingSystemChecked} />
              </td>
              <td>
              <input type='checkbox' data-form="D2" data-name="15" data-key="notCarried" onChange={onWorkingSystemChecked} />
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="15" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
            ...
            <tr>
              ...
              <td>
                <input type='checkbox' data-form="D2" data-name="16" data-key="carriedOut" onChange={onWorkingSystemChecked} />
              </td>
            ...
            <tr>
              ...
              <td>
              <input type='checkbox' data-form="D2" data-name="17" data-key="carriedOut" onChange={onWorkingSystemChecked} />
              </td>
              <td>
              <input type='checkbox' data-form="D2" data-name="17" data-key="notCarried" onChange={onWorkingSystemChecked} />
              </td>
              <td style={{ padding: '0 5px' }}>
                <input type='text' data-form="D2" data-name="17" data-key="remarks" onChange={onWorkingSystem}/>
              </td>
            </tr>
          </tbody>
        </table>
