...
const A2Top = ({ onProductsDescription, state }) => {
  const { D1 } = state;
  ...
  return (
    <TopBox>
      ...
      <div className='top-description'>
        ...
        <div className='form2'>
          <input type='text' data-name="4" data-form="D1" value={D1[4] || ''} onChange={onProductsDescription} />
        </div>
        <div className='form2'>
          CO2 flooding line leading to;
          <input type='text' data-name="5" data-form="D1" value={D1[5] || ''} onChange={onProductsDescription} style={{ width: 30 }} /> <span>Nos.</span>
        </div>
        <div className='form1'>
